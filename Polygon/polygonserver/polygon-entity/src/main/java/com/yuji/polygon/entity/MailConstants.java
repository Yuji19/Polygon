...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "yuji.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "yuji.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "yuji.mail.routing.key";
}
